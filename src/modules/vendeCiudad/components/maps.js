...
import { Platform, StyleSheet, Text, View, Image, Alert, PermissionsAndroid, TouchableOpacity } from 'react-native';
...
export default class Maps extends Component {
            ...
            if (this.props.ubicacionIncidencia) {
               ...
               navigator.geolocation.getCurrentPosition(
                  (position) => {
                     ...
                     try {
                        AsyncStorage.setItem('@Reporte:latitud', this.state.region.latitude.toString());
                        AsyncStorage.setItem('@Reporte:longitud', this.state.region.longitude.toString());
                     } catch (e) {
   ...
   render() {
      ...
      if (this.props.ubicacion != null) {
         verRuta = <TouchableOpacity onPress={this.onPress} style={styles.button}><Text style={styles.buttonText}>Ver ruta</Text></TouchableOpacity>
      }
      return (
               ...
               >
                  {
                     this.props.ubicacion ?
                        <MapView.Marker
                           coordinate={{ latitude: parseFloat(this.props.ubicacion.latitud), longitude: parseFloat(this.props.ubicacion.longitud) }}
                  ...
                  }
                  {
                     this.state.verRuta ?
                        <MapViewDirections
                           ...
                           destination={{ latitude: parseFloat(this.props.ubicacion.latitud), longitude: parseFloat(this.props.ubicacion.longitud) }}
                     ...
                     this.props.listaMarker ?
                        this.props.listaMarker.map(marker => (
                           <MapView.Marker
                              ref={marker => { this.marker = marker }}
                              key={marker.id}
                              coordinate={{ latitude: parseFloat(marker.latitud), longitude: parseFloat(marker.longitud) }}
                              title={marker.nombre}
