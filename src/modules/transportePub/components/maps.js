...
import { Platform, StyleSheet, Alert, View, PermissionsAndroid, Image } from 'react-native';
import MapView, { PROVIDER_GOOGLE, AnimatedRegion, Polyline } from 'react-native-maps';
   ...
   ruta = (linea) => {
      ...
      return (
         <View>
            ...
            />
            <MapView.Marker
               coordinate={{ latitude: parseFloat(linea.inicio_lat), longitude: parseFloat(linea.inicio_lon) }}
               title={linea.inicio}
            >
               {myIcon}
            </MapView.Marker>
            <MapView.Marker
               coordinate={{ latitude: parseFloat(linea.final_lat), longitude: parseFloat(linea.final_lon) }}
               title={linea.final}
            >
               {myIcon}
            </MapView.Marker>
               ...
               >
                  {
                     this.props.linea ?
                        ...
                        : this.props.listaTransp ?
                           this.props.listaTransp.map((listaTransp) => this.rutas(listaTransp))
                           : null
                  }
               </MapView> : null}
         </View>
